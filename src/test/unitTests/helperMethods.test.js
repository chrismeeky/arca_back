...
describe('Unit tests for helper methods', () => {
  ...
  it('should return 200 status code and the success '
    + 'message when "requestSuccessful" method is called', () => {
    ...
    expect(response).to.have.property('message');
    expect(response.message).to.equal('custom success message');
  });
});
